...
export default function AboutUs(props) {
  ...
  React.useEffect(() => {
    document.title = 'Abount Us - Laundry Basket';
  }, []);
  ...
  return (
    ...
    >
      ...
      <Helmet>
        <meta
          name='description'
          content='Learn about Laundry Basket, your go-to laundry and dry cleaning service in North York, Vaughan and Richmond Hill. We offer convenient, reliable, and professional laundry and dry cleaning solutions with free pickup and delivery.'
        />
        <meta
          name='keywords'
          content='Laundry Basket, laundry service, dry cleaning, North York, Vaughan, Richmond Hill, laundry pickup and delivery, professional laundry service, eco-friendly laundry, affordable laundry service'
        />
        <meta name='author' content='Laundry Basket' />
        <link rel='canonical' href='https://www.laundrybasket.ca/about-us' />
      </Helmet>
      {servicesLoaded && (
        <Box sx={{ width: '90%', mx: 'auto' }}>
          ...
          >
            <Grid sx={{ height: 'auto', alignContent: 'center' }} item xs={12} sm={12} md={5}>
              <img
                ...
                src={require('../assets/images/Laundry-2.webp')}
                alt='Professional laundry pickup and delivery in Toronto'
              />
            </Grid>
            <Grid sx={{ height: 'auto', alignContent: 'center' }} item xs={12} sm={12} md={7}>
              <Box sx={{ width: { xs: '100%', sm: '100%', md: '95%' }, ml: 'auto' }}>
                <Typography component='h1' variant='h3' sx={{ color: 'text.secondary', pb: 2.5 }}>
                  We Make Laundry{' '}
                  <Typography variant='h3' sx={{ color: 'text.primary', display: 'inline' }}>
                    Effortless!
                  </Typography>
                </Typography>
                <Typography component='h4' variant='subtitle1' sx={{ color: 'text.secondary', pb: 2 }}>
                  At{' '}
                  <a
                  ...
                  , we believe that laundry shouldn’t be a chore—it should be simple, convenient, and stress-free. That’s why
                  we offer premium laundry services with free pickup and delivery, ensuring fresh, clean clothes at your
                  doorstep without the hassle.
                </Typography>
                <Stack direction='row' alignItems='center' gap={2} sx={{ my: 1, pt: 1 }}>
                  <img
                    ...
                    alt='new'
                  />
                  <Typography sx={{ width: '100%', color: 'text.secondary', fontWeight: 'bold' }} variant='subtitle2'>
                    Convenience at Your Doorstep -{' '}
                    <Typography variant='subtitle2' sx={{ color: 'text.secondary', display: 'inline', fontWeight: 500 }}>
                ...
                <Stack direction='row' alignItems='center' gap={2} sx={{ my: 1 }}>
                  ...
                  <Typography sx={{ width: '100%', color: 'text.secondary', fontWeight: 'bold' }} variant='subtitle2'>
                    Professional Care -{' '}
                    <Typography variant='subtitle2' sx={{ color: 'text.secondary', display: 'inline', fontWeight: 500 }}>
                      From Wash and Fold to Dry Cleaning, we cater to all your laundry needs with expert handling.
                    </Typography>
                  </Typography>
                </Stack>
                <Stack direction='row' alignItems='center' gap={2} sx={{ my: 1 }}>
                ...
                <Grid key={index} item xs={12} sm={6} md={4} sx={{ px: 2 }}>
                  <Grid container spacing={{ xs: 2.5, sm: 1.5, md: 2.5 }}>
                    ...
                    <Grid item xs={10} sm={9} md={10}>
                      <Box sx={{ pl: 1 }}>
                        <Typography sx={{ color: 'text.secondary', textAlign: 'left' }} component='h4' variant='h5'>
                          {item.title}
                        </Typography>
          ...
          >
            <Grid item xs={12} sm={12} md={5} sx={{ display: { xs: 'block', sm: 'block', md: 'none' } }}>
              <img
                className='how-it-works-img'
                src={require('../assets/images/Laundry-3.webp')}
            ...
            <Grid sx={{ height: 'auto', alignContent: 'center' }} item xs={12} sm={12} md={7}>
              <Box sx={{ width: '95%', mr: 'auto' }}>
                ...
                <Typography variant='subtitle1' sx={{ color: 'text.secondary', pb: 2 }}>
                  ...
                  , we set out to change that. Our goal was simple—to make laundry effortless and accessible to everyone. We
                  built a service where fresh, professionally cleaned clothes could be just a pickup away. No more laundromat
                  visits, no more waiting—just convenient, high-quality laundry care delivered to your door.
                </Typography>
                <Typography variant='title' sx={{ color: 'text.secondary', pb: 2 }}>
                  ...
                  – Fresh Laundry, Without the Effort!
                </Typography>
              </Box>
            </Grid>
            <Grid
              ...
              sm={12}
              md={5}
              sx={{ display: { xs: 'none', sm: 'none', md: 'flex' }, height: 'auto', alignContent: 'center' }}
            >
              <img
                className='how-it-works-img'
                src={require('../assets/images/Laundry-3.webp')}
