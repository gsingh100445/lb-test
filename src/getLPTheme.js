...
const getDesignTokens = (mode) => ({
  palette: {
    ...
    text: {
      ...
      mid: gray[500],
      white: 'white',
      ...(mode === 'dark' && { primary: 'hsl(205, 100%, 50%)', secondary: gray[200] }),
    },
    action: {
  ...
  typography: {
    ...
    h1: {
      fontSize: customTheme.typography.pxToRem(65),
      fontWeight: 600,
      lineHeight: 1.2,
      letterSpacing: -0.5,
      '@media (min-width:320px)': {
        fontSize: customTheme.typography.pxToRem(50),
      },
    ...
    h2: {
      fontSize: customTheme.typography.pxToRem(52),
      fontWeight: 600,
      lineHeight: 1.2,

      '@media (min-width:320px)': {
        fontSize: customTheme.typography.pxToRem(45),
      },
      '@media (min-width:480px)': {
        fontSize: customTheme.typography.pxToRem(45),
      },
    ...
    h3: {
      ...
      '@media (min-width:320px)': {
        fontSize: customTheme.typography.pxToRem(35),
      },
      '@media (min-width:480px)': {
        fontSize: customTheme.typography.pxToRem(35),
      },
    ...
    body2: {
      fontSize: customTheme.typography.pxToRem(13),
      '@media (min-width:320px)': {
        fontSize: customTheme.typography.pxToRem(11),
      },
      '@media (min-width:480px)': {
        fontSize: customTheme.typography.pxToRem(11),
      },
    ...
    caption: {
      fontSize: customTheme.typography.pxToRem(11),
      '@media (min-width:320px)': {
        fontSize: customTheme.typography.pxToRem(9),
      },
      '@media (min-width:480px)': {
        fontSize: customTheme.typography.pxToRem(9),
      },
            ...
            variants: [
              ...
              },
              {
                ...
                style: {
                  ...
                  ...theme.applyStyles('dark', {
                    // '&:hover': {
                    //   background: alpha(brand[600], 0.1),
                    //   boxShadow: 'none',
                    //   border: `1px solid ${brand[500]}`,
                    //   color: brand[300],
                    // },
              ...
              },
              {
                ...
                style: {
                  ...
                  backgroundColor: gray[900],
                  borderRadius: '.3rem',
                  backgroundImage: `linear-gradient(to bottom, ${alpha(gray[900], 0.8)}, ${gray[900]})`,
                  boxShadow: `inset 0 2px 0 ${alpha(gray[900], 0.2)}, inset 0 -2px 0 ${alpha(gray[900], 0.4)}`,
                  border: `1px solid ${gray[900]}`,
                  // '&:hover': {
                  //   background: alpha(gray[300], 0.1),
                  ...
                  ...theme.applyStyles('dark', {
                    ...
                    borderRadius: '.3rem',
                    backgroundImage: `linear-gradient(to bottom, ${alpha(gray[100], 0.8)}, ${gray[100]})`,
                    boxShadow: `inset 0 2px 0 ${alpha(gray[100], 0.2)}, inset 0 -2px 0 ${alpha(gray[100], 0.4)}`,
