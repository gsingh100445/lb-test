...
export default function DryCleanerPickUpService(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Dry Cleaner Pick Up Service from Laundry Basket';
  }, []);
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  ...
                  offers convenient pickup and expert cleaning service.
                </Typography>
                <Grid
                  spacing={2}
                  container
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              <Typography sx={{ color: 'white', pt: 2 }} variant='title' component='p' textAlign='left'>
                Dry Cleaner Pick Up Service
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Forget the hassle — Laundry Basket provides trusted dry cleaner pickup services.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                We collect, professionally clean, and deliver your items 7 days a week, ensuring fresh, crisp results every
                time.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Book today and enjoy effortless dry cleaning pickup service!
              </Typography>
            </Grid>
            <Grid item xs={12} sm={5} md={5}>
              <img className='how-it-works-img' src={require('../assets/images/services/dry-cleaning.webp')} alt='Premium dry cleaning service for delicate fabrics' />
            </Grid>
          </Grid>
        </Box>
      </Box>
