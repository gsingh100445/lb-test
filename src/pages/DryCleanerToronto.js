...
export default function DryCleanerToronto(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Dry Cleaner Toronto - Dry Clean PickUp and Delivery from Laundry Basket';
  }, []);
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  ...
                  your dry cleaning right to your door in Toronto.
                </Typography>
                <Grid
                  spacing={2}
                  container
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              ...
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Looking for a convenient and reliable dry cleaner in Toronto? Laundry Basket offers professional dry cleaning
              ...
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Whether you need a trusted dry cleaner nearby or a hassle-free dry cleaning pickup and delivery service in
                Toronto, Laundry Basket has you covered. Our easy-to-use website and mobile app make scheduling simple — book
                your dry cleaning 7 days a week and skip the trip to the dry cleaner!
              </Typography>
            </Grid>
            <Grid item xs={12} sm={5} md={5}>
              <img className='how-it-works-img' src={require('../assets/images/services/dry-cleaning.webp')} alt='Dry cleaned clothes with pickup and delivery in Toronto' />
            </Grid>
          </Grid>
        </Box>
      </Box>
