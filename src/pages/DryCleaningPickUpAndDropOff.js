...
export default function DryCleanerNearMe(props) {
  ...
  React.useEffect(() => {
    document.title = 'Dry Cleaning Pick Up and Drop Off from Laundry Basket';
  }, []);
          ...
          <div style={{ zIndex: 99, width: '100%', height: '100%', display: 'contents' }} className='text-center'>
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  Dry cleaning pickup and delivery made simple with
                  <Typography
                    component='span'
                    sx={{
                      textAlign: 'center',
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              ...
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Laundry Basket offers seamless dry cleaning pickup and drop-off service. We make laundry day easy with expert
                care, eco-friendly products, and reliable delivery right to your door.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Schedule online or by app and enjoy dry cleaning without leaving home!
              </Typography>
              {/* <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
            ...
            <Grid item xs={12} sm={5} md={5}>
              <img className='how-it-works-img' src={require('../assets/images/services/dry-cleaning.webp')} alt='Premium dry cleaning and delivery at your doorstep' />
            </Grid>
          </Grid>
        </Box>
      </Box>
