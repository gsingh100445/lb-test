...
export default function IroningServiceNearMe(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Ironing Service Near Me - Laundry PickUp and Delivery from Laundry Basket';
  }, []);
  ...
  return (
    ...
    >
      ...
      <Helmet>
        <meta
          name='description'
          content='Discover professional ironing services near you with Laundry Basket. Enjoy wrinkle-free clothes delivered right to your door. Book now!'
        />
        <meta
          name='keywords'
          content='ironing service, ironing near me, laundry pickup, laundry delivery, wrinkle-free clothes, professional ironing, laundry basket'
        />
        <link rel='canonical' href='https://www.laundrybasket.ca/ironing-service-near-me' />
      </Helmet>
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              <Typography sx={{ color: 'white', pt: 2 }} variant='title' component='p' textAlign='left'>
                Ironing Service Near You
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Tired of spending hours behind an ironing board? Looking for a reliable{' '}
                <a
                  style={{ cursor: 'pointer', color: '#0095ff' }}
              ...
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                ...
                service today through our simple website or mobile app — 7 days a week, no ironing board needed!
              </Typography>
            </Grid>
