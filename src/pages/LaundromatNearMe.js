...
export default function LaundromatNearMe(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Laundromat Near Me - Laundry PickUp and Delivery from Laundry Basket';
  }, []);
          ...
          <div style={{ zIndex: 99, width: '100%', height: '100%', display: 'contents' }} className='text-center'>
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  Save time by skipping the laundromat. Let
                  <Typography
                    component='span'
                    sx={{
                      textAlign: 'center',
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              ...
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Looking for a reliable and convenient laundry service in your area? Laundry Basket has you covered with
                professional laundry pickup and delivery service!
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                At Laundry Basket, we bring expert garment care straight to your doorstep. With years of experience, a strong
                focus on customer satisfaction, and a commitment to eco-friendly products, we make laundry day easy and
                worry-free.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Whether you need a dependable alternative to a laundromat near you or a full-service wash and fold pickup,
                Laundry Basket is ready to help. With our simple website and mobile app, you can schedule pickups and
                deliveries 7 days a week — no need to waste time on trips to the laundromat!
              </Typography>
            </Grid>
            <Grid item xs={12} sm={5} md={5}>
              <img className='how-it-works-img' src={require('../assets/images/services/wash-fold.webp')} alt='Customer receiving dry cleaned clothes at home' />
            </Grid>
          </Grid>
        </Box>
      </Box>
