...
export default function LaundryPickUpAndDropOff(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Laundry Pick Up and Drop Off from Laundry Basket';
  }, []);
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  ...
                  picks up, cleans, and drops off fresh clothes right to your door.
                </Typography>
                <Grid
                  spacing={2}
                  container
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              ...
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Laundry Basket offers professional laundry pick-up and drop-off service, saving you time and effort. Our team
                uses eco-friendly cleaning methods and delivers clean, fresh clothes every time.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
