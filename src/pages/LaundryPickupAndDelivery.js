...
export default function LaundryPickupAndDelivery(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Laundry PickUp and Delivery from Laundry Basket';
  }, []);
          ...
          <div style={{ zIndex: 99, width: '100%', height: '100%', display: 'contents' }} className='text-center'>
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  Convenient laundry pickup and delivery 7 days a week with
                  <Typography
                    component='span'
                    sx={{
                      textAlign: 'center',
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              ...
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Laundry Basket makes laundry simple. We pick up your clothes, wash or dry clean them with expert care, and
                deliver them back fresh and folded.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Book your laundry pickup and delivery today and skip the laundromat lines!
              </Typography>
              {/* <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
