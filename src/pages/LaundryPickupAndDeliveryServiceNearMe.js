...
export default function LaundryPickupAndDeliveryServiceNearMe(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Laundry Pickup and Delivery Service Near Me - from Laundry Basket';
  }, []);
          ...
          <div style={{ zIndex: 99, width: '100%', height: '100%', display: 'contents' }} className='text-center'>
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  Fresh laundry without leaving home.
                  <Typography
                    component='span'
                    sx={{
                      textAlign: 'center',
                  ...
                  delivers clean clothes to your door with easy pickup and delivery.
                </Typography>
                <Grid
                  spacing={2}
                  container
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              <Typography sx={{ color: 'white', pt: 2 }} variant='title' component='p' textAlign='left'>
                Laundry Pickup and Delivery Service Near Me
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Laundry Basket brings laundry service right to your doorstep.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Our pickup and delivery service is perfect for busy lifestyles, offering expert cleaning, eco-friendly
                products, and reliable scheduling.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                No laundromat visits needed — schedule online today!
              </Typography>
            </Grid>
