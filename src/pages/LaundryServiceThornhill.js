...
export default function LaundryServiceThornhill(props) {
  const navigation = useNavigate();

  React.useEffect(() => {
    document.title = 'Laundry Service Thornhill - Laundry PickUp and Delivery from Laundry Basket';
  }, []);
          ...
          <div style={{ zIndex: 99, width: '100%', height: '100%', display: 'contents' }} className='text-center'>
            ...
            >
              <Box className='wow fadeIn' sx={{ my: 'auto' }}>
                ...
                >
                  Get fresh laundry fast in Thornhill.
                  <Typography
                    component='span'
                    sx={{
                      textAlign: 'center',
          ...
          <Grid container justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} sm={6} md={6}>
              <Typography sx={{ color: 'white', pt: 2 }} variant='title' component='p' textAlign='left'>
                Laundry Service Thornhill
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Laundry Basket brings top-notch laundry service to Thornhill homes.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Enjoy professional wash and fold or dry cleaning with easy pickup and delivery, 7 days a week.
              </Typography>
              <Typography sx={{ color: 'white', pt: 2 }} variant='subtitle2' component='p' textAlign='left'>
                Book online or through our app for the easiest laundry experience in Thornhill!
              </Typography>
            </Grid>
            <Grid item xs={12} sm={5} md={5}>
              <img
                ...
                alt='Professional laundry pickup and delivery in Thornhill'
              />
            </Grid>
          </Grid>
        </Box>
